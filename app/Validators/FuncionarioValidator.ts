...
export default class FuncionarioValidator {
  ...
  public messages: CustomMessages = {
    ...
    'sexo.alpha' : 'So pode coloca letras no campo sexo, sendo, Masculino/M ou Feminino/F',
    'idAcademia.exists' : 'A Academia que esta tentando referencia não existe não existe'
  }
}
